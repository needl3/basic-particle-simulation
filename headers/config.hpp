...
static cu_chort P_MASS             = 10;     // Kilograms
static int P_DENSITY               = 1000;     // Kg/meter-cubed
static cu_chort P_S_MAX            = 1;
static cu_chort P_S_MIN            = 1;
static float P_SIZE                = std::pow(3.0f/(4.0f*PI)*float(P_MASS)/P_DENSITY, 1.0f/3);    // Radius of circular particle in meters

// Universe Properties
static float U_GRAVITY             = 0;    //Meters per second squared
